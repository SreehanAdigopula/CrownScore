      ...
      <div className="mx-auto max-w-3xl p-4 lg:p-10">
        <section className="neu-surface rounded-[32px] p-6 sm:p-8">
          <div className="flex items-center gap-3">
            <span className="neu-inset grid size-12 place-items-center rounded-[20px] text-primary"><Bot className="size-5" /></span>
            <div>
          ...
          <div className="mt-8 flex gap-3 rounded-[28px] p-5 neu-inset">
            ...
            <p className="text-xs leading-5 text-muted-foreground">The coach receives structured facts only. It cannot change scores, safety results, database writes, or recommend medication changes.</p>
          </div>
        </section>
      </div>
    </AppShell>
