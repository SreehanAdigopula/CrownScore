      ...
      <div className="mx-auto max-w-5xl p-4 lg:p-10">
        ...
        {records.length === 0 ? (
          <section className="neu-surface-lg rounded-[32px] p-8 text-center sm:p-12">
            ...
            <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-muted-foreground">Your first usable check-in will save a non-diagnostic visible-health result.</p>
              ...
              return (
                <Link href={`/history/${point.id}`} key={point.id} className="grid grid-cols-[auto_1fr_auto_auto] items-center gap-4 px-5 py-5 transition hover:bg-[#d8dee7] neu-focus">
                  ...
                  <div className="min-w-0">
                    <p className="font-heading font-extrabold tracking-tight">{point.treatmentWeek === 0 ? "First check-in" : `Week ${point.treatmentWeek}`}</p>
