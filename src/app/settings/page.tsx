      ...
      <div className="mx-auto max-w-3xl space-y-6 p-4 lg:p-10">
        <section className="neu-surface rounded-[28px] p-6">
          ...
          <div className="mt-4 flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="font-heading text-2xl tracking-tight">Theme</h1>
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                Switch between the sage clinic light theme and a deep forest dark workspace.
              </p>
            </div>
            <button
              type="button"
        ...
        <section className="neu-surface rounded-[28px] p-6">
          <h2 className="font-heading text-2xl tracking-tight">Privacy and data</h2>
        ...
        <section className="neu-surface rounded-[28px] p-6">
          <div className="flex gap-3">
            ...
            <div>
              ...
              <h2 className="mt-2 font-heading text-2xl tracking-tight">Neon, Vercel, and API keys</h2>
        ...
        <section className="neu-surface rounded-[28px] p-6">
          <div className="flex gap-3">
            ...
            <div>
              <h2 className="font-heading text-2xl tracking-tight">What CrownScore can and cannot do</h2>
        ...
        <section className="rounded-[28px] border border-destructive/35 bg-destructive/8 p-6 text-destructive">
          <h2 className="font-heading text-2xl tracking-tight">Delete CrownScore data</h2>
          ...
          {deleted && <p className="mt-3 text-sm font-bold text-success">Cloud data and local cache deleted.</p>}
