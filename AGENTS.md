...
## Use web search very liberally. Default to it for all docs on frameworks, libraries, APIs, best practices, the latest dependencies, latest version numbers, etc.
## Use the frontend-design skill whenever you need to do any UI/frontend work or even touch any frontend components.

---

# CRITICAL INFORMATION LEARNED WHILE BUILDING
